        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarriageVenue = table.Column<string>(type: "text", nullable: true),
                    MarriageDate = table.Column<DateOnly>(type: "date", nullable: true),
                    EngagementVenue = table.Column<string>(type: "text", nullable: true),
                    EngagementDate = table.Column<DateOnly>(type: "date", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Users_PartnerId",
